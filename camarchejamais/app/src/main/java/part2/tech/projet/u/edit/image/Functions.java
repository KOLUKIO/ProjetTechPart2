...
public class Functions {
     ...
     */
    public int newColor(int color, double hue) {
        // rgbToHsl
     ...
     */
    public float getMinHistogram(int[] hist){
        for(int i=0; i<255; i++){
     ...
     */
    public float getMaxHistogram(int[] hist){
        for(int i=255; i>0; i--){
            if(hist[i]!=0) return i;
        }
        return 0;
